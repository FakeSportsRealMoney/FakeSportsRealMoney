...
cronJobs.overdueCheck = new CronJob('00 30 13 * * *', function() {
  //I would get some promises in here, could clean up this pyramid of doom
      ...
      request(herokuUrl + league._id + '/user/overdue', (err, response, html) => {
        ...
        overdueMembers.forEach((member) => {
          twilio.messages.create({
            ...
            body: 'Hi ' + member.name + ', you are overdue on your fantasy football dues by $' + member.amountDue + '.00. To stop receiving these notifications, pay your league dues.'
          }, function(err, data) {
            if (err) {
              console.log(err);
            }
          ...
          let mailOptions = {
            ...
            text: 'You owe $' + member.amountDue + '.00 to your fantasy football league. To stop receiving these notifications, pay your league dues.',
            html: '<p>You owe $' + member.amountDue + '.00 to your fantasy football league. To stop receiving these notifications, pay your league dues.</p>'
          };
